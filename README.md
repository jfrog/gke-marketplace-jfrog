...
```shell
docker pull gcr.io/jfrog-gc-mp/jfrog-artifactory/deployer:6.18
```
...
```shell
./scripts/mpdev scripts/install  --deployer=gcr.io/jfrog-gc-mp/jfrog-artifactory/deployer:6.18   --parameters='{"name": "'$NAME'", "namespace": "'$NAMESPACE'"}'
