...
```shell
docker pull gcr.io/jfrog-gc-mp/jfrog-artifactory/deployer:7.7
```
...
```shell
./scripts/mpdev scripts/install  --deployer=gcr.io/jfrog-gc-mp/jfrog-artifactory/deployer:7.7   --parameters='{"name": "'$NAME'", "namespace": "'$NAMESPACE'"}'
