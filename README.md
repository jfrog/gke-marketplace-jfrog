...
```shell
docker pull gcr.io/jfrog-gc-mp/jfrog-artifactory/deployer:7.6
```
...
```shell
./scripts/mpdev scripts/install  --deployer=gcr.io/jfrog-gc-mp/jfrog-artifactory/deployer:7.6   --parameters='{"name": "'$NAME'", "namespace": "'$NAMESPACE'"}'
